...
View Portfolio • GitHub • ORCID • LinkedIn • 💖 Sponsor
💼 Available for Hire
...
�
Load image
Profile: upwork.com/freelancers/~0165288f789d304e87
Rate: $55.00/hour
...
Developed Red Team OSINT Tool - Production-grade reconnaissance framework with tamper-evident storage
Architected CIVWATCH - Civic transparency platform with ML-driven analysis
Built OBELISK_CORE - Multi-agent AI system with auditable decision chains
💻 Technical Stack
...
→ View Full Upwork Profile | → Hire Me Now
�

💖 Support My Open Source Work
I maintain these projects in my free time while building production-grade tools for AI automation, game networking, and cybersecurity. If my work has helped you or your organization, please consider becoming a sponsor.
...
Red Team OSINT Tool
Production-grade OSINT reconnaissance framework
🔍 Multi-source intelligence gathering (RSS, HTTP, Tor/.onion)
🔒 Tamper-evident SQLite storage with cryptographic hash chains
🤖 Automated IOC extraction (IPs, domains, URLs, emails, hashes)
🚨 Webhook & SMTP alerting with keyword/regex matching
🧅 Tor integration for anonymous .onion service monitoring
🛡️ Content enrichment with DNS/WHOIS lookups and diff detection
CIVWATCH
...
🎯 Recent Achievements
January 2026
✅ Released Red Team OSINT Tool - Production-grade reconnaissance framework
✅ Activated GitHub Sponsors for sustainable open source
✅ Shipped production infrastructure for CONductOR (CI/CD, tests, docs)
✅ Launched professional portfolio site at powder-ranger.github.io
...
Sponsorship: github.com/sponsors/POWDER-RANGER
Location: Remote-preferred | Keokuk, Iowa, USA
�

Building tools that make impossible workflows possible.
© 2026 Curtis Charles Farrar • All projects MIT licensed
�